...
Describe 'Install-CopilotAtelier' -Tag 'Unit' {
    Context 'When deploying into a clean profile' {
        BeforeAll {
            ...
            $script:settingsPath = Join-Path -Path $script:configPath -ChildPath 'Code/User/settings.json'
        ...
        It 'Should merge the repository keybindings' {
            $keybindingPath = Join-Path -Path $script:configPath -ChildPath 'Code/User/keybindings.json'
    ...
    Context 'When legacy location settings are present' {
        BeforeAll {
            ...
            $settingsDirectory = Join-Path -Path $script:configPath -ChildPath 'Code/User'
