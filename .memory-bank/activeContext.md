...
yesterday's schema re-verification opened. `main` is clean and carries the
Custom agent slug rename (`390522b`), the `software-architect` agent
(`287abdf`), and the release provenance fix. Nothing is in flight.
